...
function escribirdias() {
    ...
    for (let i = 1; i < 7; i++) {
        ...
        for (let j = 0; j < 7; j++) {
            ...
            celda.style.backgroundColor = "rgba(211, 157, 232,0.300)";
            celda.style.color = "rgba(0,0,0,0.300)";
            //domingos en rojo
            if (j == 6) {
...
function mesantes() {
    ...
    cabecera() //llamada a función de cambio de cabecera
    escribirdias() //llamada a función de cambio de tabla.
}
